class UsersController < ApplicationController
  def show
    ...
    @badges << { url: "https://res.cloudinary.com/ddrxkfzlk/image/upload/v1679503447/You_re_Such_a_Smartie_rmhb8b.jpg", title: "First 10 answered correctly!" }  if @total_correct >= 10
    ...
    @badges << { url: "https://res.cloudinary.com/ddrxkfzlk/image/upload/v1679503492/Trophy_for_the_winners_vector_clip_art_zhj3bm.jpg", title: "first 20 big boi", title: "First 20 answered!Keep going! " } if @total_a >= 20
